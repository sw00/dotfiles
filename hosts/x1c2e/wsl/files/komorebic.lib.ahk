...
Start(ffm, config, await_configuration, tcp_port, whkd) {
    RunWait("komorebic.exe start " ffm " --config " config " --await-configuration " await_configuration " --tcp-port " tcp_port " --whkd " whkd, , "Hide")
}
