---
name: oracle
description: Reasoning escalation (GLM-5.3-Flash). Diagnoses blockers or produces implementation plans, depending on the request. First escalation rung when stuck, or before big multi-file tasks.
