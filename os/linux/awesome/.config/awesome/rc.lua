...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(wallpaper, s, 0)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, 'Escape', function()
        awful.spawn.with_shell 'XSECURELOCK_PASSWORD_PROMPT=kaomoji xsecurelock || kill -9 -1'
    ...
    awful.key({}, 'Print', function()
        awful.spawn.easy_async 'flameshot gui'
    end),
    ...
    end, { description = 'audio mute', group = 'volume' }),
    awful.key({}, 'XF86AudioMicMute', function()
        awful.util.spawn('pactl set-source-mute @DEFAULT_SOURCE@ toggle', false)
    end, { description = 'mic mute', group = 'volume' }),

    -- Other media keys
    awful.key({}, 'XF86AudioNext', function()
        awful.spawn.with_shell 'playerctl next'
    end, { description = 'skip to next', group = 'media' }),
    awful.key({}, 'XF86AudioPrev', function()
        awful.spawn.with_shell 'playerctl previous'
    end, { description = 'back to previous', group = 'media' }),
    ...
    end, { description = 'Configure displays', group = 'display' }),
    ...
    awful.key({ modkey, 'Control' }, 'BackSpace', awesome.restart, { description = 'reload awesome', group = 'awesome' }),
...
clientkeys = gears.table.join(
    ...
    awful.key({ 'Control', 'Shift' }, 'q', function(c)
        c:kill()
